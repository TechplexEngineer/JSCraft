...
Code.importPrettify = function() {
  ...
  link.setAttribute('href', 'resources/compiled/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('src', 'resources/compiled/prettify.js');
...
document.write('<script src="resources/compiled/msg/js/' + Code.LANG + '.js"></script>\n');
